...
BASE_DIR = '/mnt/c/Users/thiago.silva/Downloads/portfolio' # Caminho base para encontrar a pasta do datalake
...
with st.expander("Filtros: ", expanded=True):
    ...
    elif len(datas_disponiveis) == 1:
            data_min = data_max = datas_disponiveis[0]
            st.info(f"Data disponível: {data_min}")
            data_selecionada = (data_min, data_max)
